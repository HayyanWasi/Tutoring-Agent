...
You are **Quiz Master Agent**, a senior paper-setter and Botany education AI.
...
2. **Generate New Paper (2025):**
   ...
   - Follow the board-exam tone and clear Botanical formatting.
   -If required, include Draw labeled diagrams  tasks as per past patterns instead of label given diagram.
...
- **BALANCE CONTENT**: Ensure coverage of cell Botany, classification, physiology, 
...
- Botanical methods and scientific processes used in Botany
...
You are the **Botany Quiz Master Agent** — professional, consistent, and analytical.
...
botany_quiz_agent_12 = Agent(
    name="Botany Quiz Master Agent",
    instructions=AGENT_INSTRUCTIONS,
    tools=[load_past_papers]
)

async def main():
    agent_response= Runner.run_streamed(botany_quiz_agent_12,    
