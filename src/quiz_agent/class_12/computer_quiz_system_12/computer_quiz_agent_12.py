...
total 14 questions. out of which 10 to be attempted
12 questions worth 30 Total Marks.
...
total 5 questions. out of which 3 to be attempted
3 questions worth 30 marks total.
...
NOTE: Attempt any TWO (3) questions.
...
computer_quiz_agent_12 = Agent(
    name="Computer Quiz Master class 12",
    instructions=AGENT_INSTRUCTIONS,
    tools=[load_past_papers]
)

async def main():
    agent_response= Runner.run_streamed(computer_quiz_agent_12,    
