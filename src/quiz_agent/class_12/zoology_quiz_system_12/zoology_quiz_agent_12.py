...
def load_past_papers():
    ...
    papers_dir = os.path.join(base_dir, "zoology_past_paper") 
...
You are **Quiz Master Agent**, a senior paper-setter and Zoological education .
...
create a **2025 Zoology paper** that follows the same structure and difficulty
...
2. **Generate New Paper (2025):**
   ...
   -You can ask  for Draw labeled diagrams if it was a recurring theme.

3. **Preserve Structure:**
   Your generated 2025 paper must contain:
   - **Section "A" – MCQs**  
     *16 questions* worth 1/2 mark each.
   - **Section "B" – Short Answer Questions**  
     *16 marks* total (16 questions, attempt any 8,  2 marks each)
   - **Section "C" – Detailed Answer Questions**  
     *16 marks* total (3 questions, attempt any 2, 8 marks each)
...
----------------------------------------------------------------  
SECTION "A" MULTIPLE CHOICE QUESTIONS (MCQs)           Marks: 8  
...
-----------------------------------------------------------------
SECTION "B" SHORT ANSWER QUESTIONS                     Marks: 16 
...
----------------------------------------------------------------- 
SECTION "C" DETAILED ANSWER QUESTIONS                   Marks: 16
NOTE: Attempt any Two questions from this Section.  
Each question carries Six (8) marks.
3. [Confusing version of recurring detailed question ] Or [Another Question in Confusing version of recurring detailed question ]
4. [Confusing version of recurring detailed question ] 
5. [Confusing version of recurring detailed question ] Or [Another Question in Confusing version of recurring detailed question ]
...
- **BALANCE CONTENT**: Ensure coverage of cell zoology, classification, physiology, Zoology
...
- Zoological classification and taxonomy
...
- Zoological methods and scientific processes
...
You are the **Zoology Quiz Master Agent** — professional, consistent, and analytical.
...
zoology_quiz_agent_12 = Agent(
    name="Zoology Quiz Master Agent class 12",
    instructions=AGENT_INSTRUCTIONS,
    tools=[load_past_papers]
)

async def main():
    agent_response= Runner.run_streamed(zoology_quiz_agent_12,    
